...
function setup() {
  ...
  restart_ = createSprite(width/2,height/2-10);
  restart_.addImage (restart);
  restart_.scale =0.5;
...
function draw() {
  ...
  textSize(20);
  text("Puntuación: "+ score, width-160,50);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(width-15,height-95,20,30);
...
function spawnClouds() {
  //escribir aquí el código para aparecer las nubes
   if (frameCount % 40 === 0) {
    ...
    cloud.y = Math.round(random(20,400));
